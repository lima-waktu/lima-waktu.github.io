...
function hitung(t) {
    ...
    wait.textContent = a, mulai = setInterval(function() {
        ...
        n = n < 10 ? "0" + n : n, i = i < 10 ? "0" + i : i, l = l < 10 ? "0" + l : l, countdown.textContent = [n, i, l].join(" : "), t <= 0 && (clearInterval(mulai), countdown.textContent = "waktu " + a, setTimeout(() => {
...
function randomTxt(t, a) {
    let e = t[0];
    t[1];
    let n = ['Mohon laporkan jika menemukan kesalahan! <br>Kontak: rootpai7z@gmail.com'];
